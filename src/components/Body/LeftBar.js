...
function LeftBar() {
  return (
    ...
    <div className="flex flex-col p-8 gap-8 text-white">
      ...
      <div className="flex gap-3 cursor-pointer"><DocumentTextIcon  className="h-6 w-6 text-gray-100" />ToDo</div>
      <div className="flex gap-3 cursor-pointer"><Cog6ToothIcon className="h-6 w-6 text-gray-100" />Settings</div>
